...
class AdventOfCodeDayOne extends Command
{
    /**
     ...
     */
    protected $signature = 'advent-of-code:day-one {file : File name or path to the input file}';

    protected $description = 'Process the rotation list and output how many times the dial lands on 0. File defaults to public storage.';
    ...
    public function handle()
    {
        ...
        foreach ($lines as $rawLine) {
            ...
            if (!in_array($direction, ['L', 'R']) || !ctype_digit($amount)) {
