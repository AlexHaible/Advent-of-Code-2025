...
it('calculates the correct sum for the sample ranges', function () {
    Storage::fake('public');
...
TXT;
    ...
    Storage::disk('public')->put('sample-ids.txt', $contents);

    artisan('advent-of-code:day-two', ['file' => 'sample-ids.txt'])
        ->expectsOutputToContain('1227775554 (took')
        ->assertExitCode(0);
});

it('calculates the correct sum for the puzzle input', function () {
    Storage::fake('public');
...
TXT;
    ...
    Storage::disk('public')->put('puzzle-ids.txt', $contents);

    artisan('advent-of-code:day-two', ['file' => 'puzzle-ids.txt'])
        ->expectsOutputToContain('52316131093 (took')
        ->assertExitCode(0);
});
